...
Line 0,384,1024,384
For x=-5 To 5
 Line 512+x*102.4,384,512+x*102.4,390
Next
For y=-4 To 4
 Line 505,y*100+384,512,y*100+384
Next
...
Color 222,222,222
Line xaxis,yaxis-ysize/2,xaxis,yaxis+ysize/2
Line xaxis-xsize/2,yaxis,xaxis+xsize/2,yaxis
...
While x<=-0.1
 Color 70,70,70
 Line x+xaxis,0,x+xaxis,GraphicsHeight()
 Color 222,222,222
 Line x+xaxis,yaxis,x+xaxis,yaxis+5
 If de Then j=i*60 Else j=i
 If i<>0 Then Text x+xaxis,yaxis+5,j
 x=x+xlen
 i=i+xinc
Wend
x#=xsize/2
...
While y<=ysize+0.1
 If y<(ysize/2)-5 Or y>(ysize/2)+5
  Color 70,70,70
  Line 0,y+yaxis-ysize/2,GraphicsWidth(),y+yaxis-ysize/2
  Color 222,222,222
  Line xaxis,y+yaxis-ysize/2,xaxis-5,y+yaxis-ysize/2
 EndIf
 Text xaxis-20,3+y+yaxis-ysize/2,i
 i=i-yinc
 y=y+ylen
Wend
...
SetFont bigfont
;arrows
Line xsize/2+xaxis,yaxis,xsize/2+xaxis+20,yaxis
Line xsize/2+xaxis+20,yaxis,xsize/2+xaxis+10,yaxis-10
Line xsize/2+xaxis+20,yaxis,xsize/2+xaxis+10,yaxis+10
Text xsize/2+xaxis+30,yaxis,"X"

Color 222,222,222
Line xaxis,yaxis-(20+ysize/2),xaxis,yaxis-ysize/2
Line xaxis,yaxis-(20+ysize/2),xaxis-10,-10+yaxis-ysize/2
Line xaxis,yaxis-(20+ysize/2),xaxis+10,-10+yaxis-ysize/2
Text xaxis,yaxis-(40+ysize/2),"Y"
...
top_old.matrix=create_matrix()
matrix_set_equal(top_old,top)

under_old.matrix=create_matrix()
